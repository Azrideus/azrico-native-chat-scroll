...
// const DISPLAY_ITEM_COUNT = 10000;
...
// 		if (actualIndex > allItemsCount) return SizeHelper.BUFFER_HEIGHT;
// 		return sizeHelper.current.getSizeOf(actualIndex) || SizeHelper.BUFFER_HEIGHT;
// 	};

// 	//the first buffer items are not really loaded, we keep them there so the scroll jumps less often
// 	const isItemLoaded = React.useCallback(
// 		(index) => {
// 			return getActualIndex(index) > allItemsCount;
// 		},
// 		[BUFFER_SIZE]
// 	);
...
// 		(index) => {
// 			return BUFFER_SIZE + dbItemCount - index - DISPLAY_ITEM_COUNT - 1;
// 		},
// 		[dbItemCount]
// 	);
...
// 		const scTarget = outerRef.current?.scrollHeight;
// 		console.log('stick to', scTarget);
// 		scrollTo(scTarget);
// 	}
...
// 	return <VirtualScroller></VirtualScroller>;
...
// 	}
// 	return (
// 		<div key={props.index} style={props.style} x-data-actual={actualIndex}>
